      ...
      <section id="features" className="py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-indigo-600 font-black uppercase tracking-widest text-sm mb-4">{t('landing.features.sectionTitle')}</h2>
      ...
      <section id="how-it-works" className="py-24 bg-slate-50 rounded-[4rem] mx-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mb-4">{t('landing.howItWorks.sectionTitle')}</h2>
          ...
          <div className="bg-white rounded-[3rem] border border-slate-200 shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 lg:p-16 bg-slate-50/50">
                <h3 className="text-3xl font-black text-slate-900 mb-6">{t('landing.pricing.sectionTitle')}</h3>
      ...
      <section id="roadmap" className="py-24 bg-slate-900 text-white rounded-[4rem] mx-4 mb-24 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-indigo-400 font-black tracking-widest uppercase text-sm mb-4">{t('landing.roadmap.sectionTitle')}</h2>
